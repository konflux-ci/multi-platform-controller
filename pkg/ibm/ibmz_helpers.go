...
func (ibmz IBMZDynamicConfig) lookUpSubnet(vpcService *vpcv1.VpcV1) (*vpcv1.Subnet, error) {
	...
	if subnet == nil {
		return nil, fmt.Errorf("failed to find subnet %s", ibmz.Subnet)
	}
	return subnet, nil
}
...
func (ibmz IBMZDynamicConfig) lookUpSshKey(vpcService *vpcv1.VpcV1) (*vpcv1.Key, error) {
	...
	if key == nil {
		return nil, fmt.Errorf("failed to find SSH key %s", ibmz.Key)
	}
	return key, nil
}
...
func (ibmz IBMZDynamicConfig) lookUpVpc(vpcService *vpcv1.VpcV1) (*vpcv1.VPC, error) {
	...
	if vpc == nil {
		return nil, fmt.Errorf("failed to find VPC network %s", ibmz.Vpc)
	}
	return vpc, nil
}
...
func (ibmz IBMZDynamicConfig) createAuthenticatedVpcService(ctx context.Context, kubeClient client.Client) (*vpcv1.VpcV1, error) {
	apiKey := ""
